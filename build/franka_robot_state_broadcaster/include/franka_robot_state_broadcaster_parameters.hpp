  ...
  public:
    ...
    rcl_interfaces::msg::SetParametersResult update(const std::vector<rclcpp::Parameter> &parameters) {
      ...
      for (const auto &param: parameters) {
        if (param.get_name() == (prefix_ + "robot_type")) {
            updated_params.robot_type = param.as_string();
    ...
    void declare_params(){
      ...
      if (!parameters_interface_->has_parameter(prefix_ + "robot_type")) {
          rcl_interfaces::msg::ParameterDescriptor descriptor;
          descriptor.description = "";
          descriptor.read_only = false;
          auto parameter = to_parameter_value(updated_params.robot_type);
          parameters_interface_->declare_parameter(prefix_ + "robot_type", parameter, descriptor);
      }
      // get parameters and fill struct fields
      rclcpp::Parameter param;
      param = parameters_interface_->get_parameter(prefix_ + "robot_type");
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "robot_type") << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.robot_type = param.as_string();
